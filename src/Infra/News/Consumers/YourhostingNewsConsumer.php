...
/**
 * Consumes news through the Yourhosting news api format. Does not use the alternative.
 *
 * @package Waterfront\Apps\API\Waterfront\Controllers
 */
class YourhostingNewsConsumer implements NewsConsumer
{
