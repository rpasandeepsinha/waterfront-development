...
readonly class ConnectorConfig
{
    public function __construct(
        ...
        Assert::stringNotEmpty($this->clientSecret, message: 'The client secret is required and can not be set as empty');
        Assert::regex($this->clientSecret, pattern: '/^[a-z0-9]+$/', message: 'The client secret syntax is not valid. only letters and digits are allowed');
    }
}
