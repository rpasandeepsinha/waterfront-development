    ...
    public function fields(NovaRequest $request)
    {
        return [
            Panel::make('Migration Data', [
                Text::make(self::translate('migration_state.external_customer_id'), 'customer.migratedCustomers.0.reference_customer_number')->sortable(),
                Text::make(self::translate('customer.attributes.reference_subscription_id'), 'migratedSubscriptions.0.reference_subscription_id')->sortable(),
                Text::make(self::translate('migrated.subscription.reference_name'), 'customer.migratedCustomers.0.reference_name')->sortable(),
                Text::make(self::translate('migrated.subscription.group_type'), 'customer.migratedCustomers.0.group_type')->sortable(),
            ]),

            Panel::make('Customer', [
                BelongsTo::make(self::translate('subscription.relations.customer'), 'customer', NovaCustomerResource::class)->sortable(),
                Text::make(self::translate('migration_state.waterfront_customer_id'), 'customer.id')->hideFromIndex(),
                Text::make(self::translate('migration_state.waterfront_customer_number'), 'customer.customer_number')->hideFromIndex(),
                ...
                Text::make(self::translate('customer.attributes.organization'), 'customer.organization')->hideFromIndex(),
                Boolean::make(self::translate('migrated.customer.administrative_successful'), 'customer.migratedCustomers.0.administrative_successful')->hideFromIndex(),
                Boolean::make(self::translate('migrated.customer.enable_invoicing'), 'customer.migratedCustomers.0.enable_invoicing')->hideFromIndex(),
                Boolean::make(self::translate('migrated.customer.successful'), 'customer.migratedCustomers.0.successful')->hideFromIndex(),
                DateTime::make(self::translate('migrated.customer.migration_date'), 'customer.migratedCustomers.0.migrated_at')->hideFromIndex(),
            ]),

            Panel::make('Contact Information', [
                Text::make(self::translate('domain-contact.attributes.country_code'), 'customer.address.country_code')->hideFromIndex(),
                Text::make(self::translate('domain-contact.attributes.phone_country_code'), 'customer.phone_country_code')->hideFromIndex(),
                Text::make(self::translate('domain-contact.attributes.phone_area_code'), 'customer.phone_area_code')->hideFromIndex(),
                Text::make(self::translate('domain-contact.attributes.phone_subscriber_number'), 'customer.phone_subscriber_number')->hideFromIndex(),
            ]),
            ...
            Panel::make('Financials', [
                ...
                Text::make(self::translate('nova-filter.customer.wallet.refund_requested_at'), 'customer.wallet.refund_requested_at')->hideFromIndex(),
            ]),
            ...
            Panel::make('Subscription', [
                ...
                BelongsTo::make(self::translate('order_line_item.attributes.product_name'), 'product', NovaProductResource::class)->sortable(),
                Text::make(self::translate('migration_state.provider'))
                    ->sortable()
                    ->displayUsing(
                        fn () => $this->resource->domainDeployment?->provider->slug->value ??
                            $this->resource->hostingDeployment?->provider?->slug->value ??
                            $this->resource->hostingDeployment?->mailProvider?->slug->value ??
                            $this->resource->hostingDeployment?->sitebuilderProvider?->slug->value ??
                            $this->resource->sslDeployment?->provider->slug->value ??
                            null
                    ),
                Text::make(self::translate('nova-action.technical_status'), 'technical_status')->sortable(),
                Text::make(self::translate('subscription.relations.product_group'), 'product.productGroup.slug')->hideFromIndex(),
                ...
                Text::make(self::translate('nova-action.administrative_status'), 'administrative_status')->hideFromIndex(),
                DateTime::make(self::translate('migration_state.subscription_last_updated'), 'updated_at')->hideFromIndex(),
                ...
                Date::make(self::translate('migration_state.subscription_next_billing_date'), 'next_billing_date')->hideFromIndex(),
            ]),
            ...
            Panel::make('Technical Details', [
                Text::make(self::translate('server.attributes.hostname'), 'server_hostname')
                    ...
                    ->hideFromIndex(),
                Text::make(self::translate('domain-contact.attributes.external_handle'), 'domainDeployment.contactOwner.pivot.external_contact')
                    ->displayUsing(
                        function () {
