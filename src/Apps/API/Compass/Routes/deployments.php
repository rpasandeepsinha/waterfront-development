...
Route::prefix('deployments/')->name('deployments.')->group(function (): void {
    ...
    Route::prefix('{subscription:uuid}')->name('show.')->group(function (): void {
        Route::put('/retry/update', [DeploymentController::class, 'updateRetry'])->name('updateRetry');
    });
});

Route::prefix('subscriptions/deployments/')->name('subscriptions.')->group(function (): void {
    Route::prefix('{hostingDeployment:subscription_uuid}')->name('deployments.')->group(function (): void {
