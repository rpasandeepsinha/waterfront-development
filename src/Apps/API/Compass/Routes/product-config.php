...
Route::prefix('product-config')->name('product-config.')->group(function (): void {
    Route::prefix('product-specs')->name('product-specs.')->group(function (): void {
    ...
    Route::prefix('product-discounts')->name('product-discount.')->group(function (): void {
    ...
    Route::prefix('product-groups')->name('product-group.')->group(function (): void {
    ...
    Route::prefix('vouchers')->name('voucher.')->group(function (): void {
