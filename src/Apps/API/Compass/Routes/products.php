...
Route::prefix('products')->name('products.')->group(function (): void {
    ...
    Route::post('/export-to-bucket', [ProductsController::class, 'exportProductsToBucket'])->name('export-products-to-bucket');

    Route::prefix('{product:uuid}')->name('show.')->group(function (): void {
        ...
        Route::get('allowed-changes', [ProductsController::class, 'allowedProductChanges'])->name('allowed-changes');
        Route::get('/relevant', [ProductsController::class, 'showRelevantProducts'])->name('relevant-products');
        Route::get('/promotions/list', [ProductsController::class, 'productPromotionsList'])->name('product-promotions.list');
    });
});
