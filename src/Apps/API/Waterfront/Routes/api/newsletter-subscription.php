...
Route::prefix('newsletter-subscriptions')
...
Route::get('newsletter-subscriptions/is-subscribed', [NewsLetterController::class, 'isSubscribed'])->name(
    'newsletter-subscriptions.is-subscribed',
)->withoutMiddleware(RequireVerifiedCustomer::class);
