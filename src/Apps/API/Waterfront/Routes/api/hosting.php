...
Route::prefix('hosting')->name('hosting.')->group(
    function (): void {
        Route::prefix('{subscription:uuid}')->group(
            function (): void {
                Route::get('customer-config', [HostingController::class, 'customerConfig'])->name('customer-config');
                Route::put('modify-customer', [HostingController::class, 'modifyCustomer'])->name('modify-customer');
        ...
        Route::prefix('{hostingDeployment:subscription_uuid}')->group(
            function (): void {
                ...
                Route::get('list-hosting-domains', [HostingController::class, 'listHostingDomains'])->name('list-hosting-domains');
...
Route::prefix('domain/{domain}/hosting')->name('hosting.')->group(
    function (): void {
        Route::post('couple-hosting', [HostingController::class, 'addDomainToExistingHosting'])->name('couple-hosting');
