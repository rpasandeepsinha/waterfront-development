...
Route::prefix('domain-contact')
    ->name('domain-contact.')
    ->group(
        function (): void {
            Route::get('contacts/{domainContact}/available-domains', [
                DomainContactController::class,
                'availableDomains',
            ])->name('contacts.available-domains');
            Route::patch('contacts/{contact}/default', [DomainContactController::class, 'setDefault'])->name(
                'contacts.set_default',
            );
