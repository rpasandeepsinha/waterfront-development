...
Route::prefix('reseller-hosting')->name('reseller-hosting.')->group(
    function (): void {
        Route::get(
            '/',
        ...
        Route::prefix('{resellerHostingDeployment:subscription_uuid}')->group(
            function (): void {
                ...
                Route::patch('/reset-password', [ResellerHostingController::class, 'resetPassword'])->name('reset-password');
                Route::get('/customers', [ResellerHostingController::class, 'getResellerSubCustomers'])->name('customers');
                Route::post('/couple-domain', [ResellerHostingController::class, 'coupleExistingDomain'])->name('couple-domain');
            }
        );
    }
);
