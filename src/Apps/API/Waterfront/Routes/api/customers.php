...
Route::prefix('customers')->name('customers.')->group(
    function (): void {
        ...
        Route::post('/direct-debit/enable', [CustomersController::class, 'enableDirectDebit'])->name('direct-debit.enable');

        Route::name('contacts.')->prefix('{customer:uuid}/contacts')->group(
            function (): void {
                Route::get('/', [CustomerContactController::class, 'index'])->name('index');
                Route::post('/', [CustomerContactController::class, 'store'])->name('store');
                Route::patch('/{customerContact}', [CustomerContactController::class, 'update'])->name('update');
...
Route::get('customers/who-am-i', [CustomersController::class, 'whoAmI'])
    ->name('customers.who-am-i')
