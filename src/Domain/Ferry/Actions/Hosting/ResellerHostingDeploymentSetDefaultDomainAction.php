...
readonly class ResellerHostingDeploymentSetDefaultDomainAction
{
    ...
    public function execute(
        ...
        $this->logger->debug(
            'Attempting to find default reseller hosting domain for subscription from remote backend',
            [
                ...
                LoggingContextKeys::SUBSCRIPTION_UUID => $resellerHostingDeployment->subscription_uuid,
        ...
        $subscription = $resellerHostingDeployment->subscription;
