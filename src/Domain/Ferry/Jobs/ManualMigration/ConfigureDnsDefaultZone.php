...
/**
 * Creates a PowerDNS zone and adds default records for the domain.
 *
 * @see MigrationJobEventListener
 */
class ConfigureDnsDefaultZone extends ManualMigrationJob
{
    public function handle(DnsMigrationService $dnsMigrationService): void
    {
        ...
        if ($zone === null) {
            throw new RuntimeException(sprintf('Zone should have been created for domain: %s', $domain));
        }
    ...
    {
        return MigrationStep::CONFIGURE_DNS_DEFAULT_ZONE;
    }
}
