...
class CnameRecord extends AbstractRecord implements DnsRecordInterface, ContentWithDotInterface
{
    public function __construct(string $name, string $content, int $ttl, bool $disabled = false)
    {
        parent::__construct('CNAME', $name, rtrim($content, '.'), $ttl, $disabled);
    }
