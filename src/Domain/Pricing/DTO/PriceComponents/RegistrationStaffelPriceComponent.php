...
class RegistrationStaffelPriceComponent extends PriceComponent
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct(PriceComponentType::REGISTRATION_STAFFEL, $fixedDiscount, $percentageDiscount, $fixedPrice, $newPrice, $appliedOrder);
    }
}
