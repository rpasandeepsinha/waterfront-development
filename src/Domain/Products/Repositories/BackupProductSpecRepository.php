...
class BackupProductSpecRepository
{
    ...
    {
        return $this->productSpecRepository->getFloatValueOfSpecification(
            product: $product,
    ...
    {
        return $this->productSpecRepository->getIntegerValueOfSpecification(
            product: $product,
    ...
    {
        $spec = $this->productSpecRepository->findBySpecification(
            product: $product,
