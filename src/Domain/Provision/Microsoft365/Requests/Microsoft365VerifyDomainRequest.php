...
class Microsoft365VerifyDomainRequest extends Microsoft365ProvisionRequest
{
    public ProvisionRequestName $name = ProvisionRequestName::VERIFY_MICROSOFT365_DOMAIN;
     ...
     * @param UuidInterface $context    The Microsoft 365 tenant UUID the domain is verified within.
