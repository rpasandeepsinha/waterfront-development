...
class Microsoft365PromoteDomainRequest extends Microsoft365ProvisionRequest
{
    public ProvisionRequestName $name = ProvisionRequestName::PROMOTE_MICROSOFT365_DOMAIN;
     ...
     * @param UuidInterface $context    The Microsoft 365 tenant UUID the domain is promoted within.
