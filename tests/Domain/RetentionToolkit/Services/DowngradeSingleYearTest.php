...
class DowngradeSingleYearTest extends IntegrationTestCase
{
    ...
    public function calculateBusiness(): void
    {
        ...
        self::assertSame(1000, $result->price->normalNetPrice);
        self::assertSame(1000, $result->payableAfterCredits);
    ...
    public function calculateConsumer(): void
    {
        ...
        self::assertSame(1000, $result->price->grossPrice);
        self::assertSame(1000, $result->price->normalNetPrice);
        self::assertSame(780, $result->payableAfterCredits);
        self::assertSame(0, $result->price->discountAmount);
        self::assertNotNull($result->effectiveDate);
        self::assertSame(
    ...
    public function applyBusiness(): void
    {
        ...
        self::assertDatabaseHas(CustomerRetentionOffer::class, [
            ...
            'selected_action' => SelectedAction::DG_OPTION_1A->value,
        ...
        self::assertSame($this->targetProduct->id, $subscriptionMutation->product_id);
        self::assertSame(1000, $subscriptionMutation->gross_price);
        self::assertSame(1000, $subscriptionMutation->net_price);
    ...
    #[Test]
    public function applyConsumer(): void
    {
        $this->app->bind(
            HarborApi::class,
        ...
        self::assertSame($this->targetProduct->id, $this->subscription->product->id);
