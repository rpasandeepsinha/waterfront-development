...
#[CoversClass(DeleteRedirectRequest::class)]
#[CoversClass(CaddyProvisionService::class)]
class DeleteCaddyRedirectIntegrationTest extends IntegrationTestCase
{
    ...
    #[Test]
    public function deleteRedirectSuccessful(): void
    {
        ...
        self::assertSame(ProvisionRequestName::DELETE_REDIRECT, $savedRequest->request_name);
        self::assertSame(
            sprintf(
                '{"domainName": "%s"}',
                $domain,
    ...
    #[Test]
    public function deleteRedirectThrowsException(): void
    {
        $domain = 'yourhosting.nl';
        $context = Uuid::uuid4();
        $caddyId = 'caddy-id';
