...
class StaffelPriceComponentHandlerTest extends IntegrationTestCase
{
    ...
    public function correctlyAddsStaffelPriceComponents(): void
    {
        ...
        new CustomerProductDiscountFactory()->for($customer)->for($discount1)->createOne();
        new CustomerProductDiscountFactory()->for($customer)->for($discount2)->createOne();
        new CustomerProductDiscountFactory()->for($customer)->for($discount3)->createOne();

        $prices = new ProductPriceComponentFactory()->createMany([
            ['product_id' => $product1->id, 'type' => PriceComponentType::REGISTRATION_STAFFEL, 'price' => 444, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::yesterday()],
            ['product_id' => $product1->id, 'type' => PriceComponentType::REGISTRATION_STAFFEL, 'price' => 123, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::now()],
            ['product_id' => $product1->id, 'type' => PriceComponentType::REGISTRATION_STAFFEL, 'price' => 777, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::tomorrow()],
            ['product_id' => $product1->id, 'type' => PriceComponentType::PROLONGATION_STAFFEL, 'price' => 321, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::now()],
            ['product_id' => $product2->id, 'type' => PriceComponentType::REGISTRATION_STAFFEL, 'price' => 333, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::yesterday()],
            ...
            ['product_id' => $product3->id, 'type' => PriceComponentType::PROLONGATION_STAFFEL, 'price' => 111, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::now()->subMonth()],
            ['product_id' => $product3->id, 'type' => PriceComponentType::PROLONGATION_STAFFEL, 'price' => 222, 'contract_period' => 12, 'billing_period' => 12, 'orderable' => true, 'starts_at' => CarbonImmutable::now()->subDays(3), 'expires_at' => CarbonImmutable::now()->subHour()],
        ]);
