...
class TechnicalResellerHostingMigrationJobDirectAdminTest extends IntegrationTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->migratedSubscription = MigratedSubscriptionsFactory::new()->createOne(['reference_subscription_id' => 'sub_1337_1']);
    ...
    public function subscriptionIsNotAReseller(): void
    {
        ...
        $this->expectExceptionMessageIs('Reseller hosting instance is not a reseller username {i_am_a_non_reseller_user} on driver {directadmin} server {directadmin.server.test}');
