...
class EmailPasswordResetTest extends TestCase
{
    ...
    public function emailPasswordResetRequest(): void
    {
        ...
        $mock = new MockHandler([
            ...
            function (RequestInterface $request) {
                self::assertSame(
                    (string) file_get_contents(__DIR__ . '/data/plesk_email_reset_password_request.xml'),
                    (string) $request->getBody(),
                );
                ...
                return new Response(
                    200,
                    [],
                    (string) file_get_contents(__DIR__ . '/data/plesk_email_reset_password_response.xml'),
                );
            },
        ]);
