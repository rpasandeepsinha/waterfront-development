...
#[CoversClass(ConfigureDnsBulkMigrationController::class)]
class ConfigureDnsBulkMigrationControllerTest extends IntegrationTestCase
{
    #[Test]
    public function thatBulkCreateDomainMigrationsReturnSuccess(): void
    {
        ...
        $mock = self::createMock(ExecuteConfigureDnsAction::class);
    ...
    #[Test]
    public function thatBulkCreateDomainMigrationsUnprocessable(): void
    {
        $this->actingAsSystem()
            ->postJson(
                $this->generateRoute('ferry.customers.subscriptions.configure_dns.bulk'),
