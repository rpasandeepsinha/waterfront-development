...
#[CoversNothing]
class AddonAndUpgradeOrderTest extends IntegrationTestCase
{
    #[Test]
    public function addonAndUpgradeInOneOrder(): void
    {
        ...
        $json = (string) file_get_contents(__DIR__ . '/data/order_addon_and_upgrade_payload.json');
