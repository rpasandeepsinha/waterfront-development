...
#[CoversClass(NovaUnsuspendSubscriptionAction::class)]
class UnsuspendSubscriptionTest extends IntegrationTestCase
{
    private NovaUnsuspendSubscriptionAction $unsuspendSubscriptionAction;
    ...
    public function setUp(): void
    {
        ...
        $this->unsuspendSubscriptionAction = self::resolve(NovaUnsuspendSubscriptionAction::class);
    ...
    public function suspendDomainSubscriptionSuccessful(): void
    {
        ...
        new AuditFactory()->create(
            [
                'event' => AuditLogEvent::SUSPENSION->value,
                'auditable_type' => DomainDeployment::class,
        ...
        self::assertSame(AdministrativeStatus::ACTIVE->value, $this->domainSubscription->administrative_status);
        self::assertSame(TechnicalStatus::OK->value, $this->domainSubscription->technical_status);
    }
    ...
    public function unsuspendSubscriptionFailedNotImplementedByDomainProvider(): void
    {
        ...
        self::assertSame(AdministrativeStatus::ACTIVE->value, $this->domainSubscription->administrative_status);
        self::assertSame(TechnicalStatus::UNSUSPENSION_FAILED->value, $this->domainSubscription->technical_status);
    }
